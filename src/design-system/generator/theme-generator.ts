...
import type { AestheticStyle } from '../tokens/aesthetic.tokens';
import type { IndustryType } from '../tokens/industry.tokens';
import { industryPalettes } from '../tokens/industry.tokens';
...
export function generateColorPalette(
  baseHex: string,
  template = industryPalettes.other
): typeof template {
  // Validate hex color
